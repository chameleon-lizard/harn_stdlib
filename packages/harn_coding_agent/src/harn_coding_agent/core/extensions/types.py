...
from harn_agent.harness.messages import CustomMessage
from harn_agent.types import AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel, ToolExecutionMode
...
from harn_ai.utils.typebox_helpers import Static, TSchema
from harn_ai.utils.oauth.types import OAuthCredentials, OAuthLoginCallbacks
...
from harn_coding_agent.core.compaction import CompactionPreparation, CompactionResult as SessionCompactionResult
from harn_coding_agent.core.event_bus import EventBus
from harn_coding_agent.core.exec import ExecOptions, ExecResult
from harn_coding_agent.core.footer_data_provider import ReadonlyFooterDataProvider
...
from harn_coding_agent.core.slash_commands import SlashCommandInfo
from harn_coding_agent.core.source_info import SourceInfo
from harn_coding_agent.core.system_prompt import BuildSystemPromptOptions
...
if TYPE_CHECKING:
    ...
    from harn_coding_agent.core.tools.bash import BashOperations, BashToolDetails, BashToolInput
    from harn_coding_agent.core.tools.edit import EditToolDetails, EditToolInput
    from harn_coding_agent.core.tools.find import FindToolDetails, FindToolInput
    from harn_coding_agent.core.tools.grep import GrepToolDetails, GrepToolInput
    from harn_coding_agent.core.tools.ls import LsToolDetails, LsToolInput
    from harn_coding_agent.core.tools.read import ReadToolDetails, ReadToolInput
    from harn_coding_agent.core.tools.write import WriteToolInput
...
class ExtensionAPI(Protocol):
    ...
    @overload
    def on(self, event: Literal["agent_end"], handler: ExtensionHandler[AgentEndEvent, None]) -> None: ...
