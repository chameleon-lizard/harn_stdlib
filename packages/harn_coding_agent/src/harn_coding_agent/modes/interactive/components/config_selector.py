...
from harn_coding_agent.core.package_manager import PathMetadata, ResolvedPaths, ResolvedResource
...
def get_group_label(metadata: PathMetadata) -> str:
    ...
    if metadata.get("source") == "auto":
        ...
        return "User (~/.harn/agent/)" if metadata.get("scope") == "user" else "Project (.harn/)"
