...
from harn_coding_agent.bun.restore_sandbox_env import restore_sandbox_env
...
def _import_register_bedrock_module() -> None:
    importlib.import_module("harn_coding_agent.bun.register_bedrock")


def _load_cli_main() -> Callable[[list[str] | None], int]:
    from harn_coding_agent.cli import main as cli_main
