...
from harn_ai.types import Api, ImageContent, Model, TextContent
from pydantic import BaseModel, ConfigDict, Field

from harn_coding_agent.config import get_readme_path
from harn_coding_agent.core.extensions.types import ToolDefinition
from harn_coding_agent.core.tools.path_utils import resolve_read_path
from harn_coding_agent.core.tools.render_utils import (
    get_text_output,
    invalid_arg_text,
    replace_tabs,
)
from harn_coding_agent.core.tools.tool_definition_wrapper import wrap_tool_definition
from harn_coding_agent.core.tools.truncate import (
    DEFAULT_MAX_BYTES,
    DEFAULT_MAX_LINES,
    TruncationResult,
    format_size,
...
from harn_coding_agent.modes.interactive.theme.theme import get_language_from_path, highlight_code
from harn_coding_agent.utils.image_resize import format_dimension_note, resize_image
from harn_coding_agent.utils.mime import detect_supported_image_mime_type_from_file
from harn_coding_agent.utils.paths import format_path_relative_to_cwd_or_absolute
...
def _format_compact_read_call(
    ...
    from harn_coding_agent.modes.interactive.components.keybinding_hints import key_text
...
def _format_read_result(
    ...
    from harn_coding_agent.modes.interactive.components.keybinding_hints import key_hint
