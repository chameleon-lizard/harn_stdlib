...
from harn_coding_agent.core.tools.render_utils import invalid_arg_text
from harn_coding_agent.core.tools.tool_definition_wrapper import wrap_tool_definition
from harn_tui import Box, Container, Spacer, Text
...
def _format_edit_result(
    ...
    from harn_coding_agent.modes.interactive.components.diff import render_diff
