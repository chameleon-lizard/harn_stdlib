...
from harn_coding_agent.cli.config_selector import select_config
...
from harn_coding_agent.utils.child_process import spawn_process
from harn_coding_agent.utils.version_check import get_latest_harn_release, is_newer_package_version
from harn_coding_agent.utils.windows_self_update import (
...
def _print_package_command_help(command: PackageCommand) -> None:
    if command == "install":
        print(
            ...
            "Options:\n"
            "  -l, --local    Install project-locally (.harn/settings.json)\n\n"
            "Examples:\n"
    ...
    if command == "remove":
        print(
            ...
            "Options:\n"
            "  -l, --local    Remove from project settings (.harn/settings.json)\n\n"
            "Examples:\n"
