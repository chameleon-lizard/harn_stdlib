...
from harn_ai.images_api_registry import ImagesApiProvider, register_images_api_provider
from harn_ai.types import AssistantImages, ImagesContext, ImagesModel, ImagesOptions
...
def _load_openrouter_images_provider_module() -> ModuleType:
    ...
    if _openrouter_images_provider_module is None:
        try:
            _openrouter_images_provider_module = importlib.import_module("harn_ai.providers.images.openrouter")
