...
from harn_coding_agent.core.output_guard import isStdoutTakenOver
from harn_coding_agent.core.settings_manager import PackageSource, SettingsManager
from harn_coding_agent.core.source_info import SourceScope
from harn_coding_agent.utils.child_process import spawn_process_sync
from harn_coding_agent.utils.git import GitSource, parse_git_url
...
def _is_offline_mode_enabled() -> bool:
    value = os.environ.get("HARN_OFFLINE")
    if not value:
        return False
