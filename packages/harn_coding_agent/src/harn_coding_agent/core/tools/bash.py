...
from harn_coding_agent.core.tools.output_accumulator import OutputAccumulator, OutputAccumulatorOptions, OutputSnapshot
from harn_coding_agent.core.tools.render_utils import get_text_output, invalid_arg_text
from harn_coding_agent.core.tools.tool_definition_wrapper import wrap_tool_definition
from harn_coding_agent.core.tools.truncate import DEFAULT_MAX_BYTES, DEFAULT_MAX_LINES, TruncationResult, format_size
from harn_coding_agent.modes.interactive.theme.theme import theme
from harn_coding_agent.utils.child_process import wait_for_child_process
from harn_coding_agent.utils.shell import (
    get_shell_config,
    get_shell_env,
    kill_process_tree,
...
from harn_tui import Container, Text, truncateToWidth
...
class _CollapsedBashPreview:
    ...
    def render(self, width: int) -> list[str]:
        ...
        from harn_coding_agent.modes.interactive.components.visual_truncate import truncate_to_visual_lines
