...
from harn_ai.types import ModelThinkingLevel

from harn_coding_agent.config import APP_NAME, CONFIG_DIR_NAME, ENV_AGENT_DIR, ENV_SESSION_DIR
...
Options:
  ...
  --offline                      Disable startup network operations (same as HARN_OFFLINE=1)
...
Environment Variables:
  ...
  HARN_PACKAGE_DIR              - Override package directory (for Nix/Guix store paths)
  HARN_OFFLINE                  - Disable startup network operations when set to 1/true/yes
  HARN_TELEMETRY                - Override install telemetry when set to 1/true/yes or 0/false/no
  HARN_SHARE_VIEWER_URL         - Base URL for /share command (default: https://harn.dev/session/)
