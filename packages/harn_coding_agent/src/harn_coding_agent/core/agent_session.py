...
from harn_agent.agent import AbortController, Agent
from harn_agent.types import AgentMessage, AgentState, AgentTool, ThinkingLevel
from harn_ai.models import clamp_thinking_level, get_supported_thinking_levels, models_are_equal
from harn_ai.providers.register_builtins import reset_api_providers
from harn_ai.session_resources import cleanup_session_resources
from harn_ai.stream import stream_simple
from harn_ai.types import AssistantMessage, ImageContent, Model, TextContent, validate_message
from harn_ai.utils.overflow import is_context_overflow

from harn_coding_agent.core.auth_guidance import (
    format_no_api_key_found_message,
    format_no_model_selected_message,
)
from harn_coding_agent.core.bash_executor import BashResult, execute_bash_with_operations
from harn_coding_agent.core.compaction import compact as run_compaction
from harn_coding_agent.core.compaction import (
...
from harn_coding_agent.core.defaults import DEFAULT_THINKING_LEVEL
from harn_coding_agent.core.export_html import export_session_to_html
from harn_coding_agent.core.export_html.tool_renderer import create_tool_html_renderer
from harn_coding_agent.core.extensions.runner import ExtensionRunner, emit_session_shutdown_event
...
from harn_coding_agent.core.messages import BashExecutionMessage
from harn_coding_agent.core.model_registry import ModelRegistry
from harn_coding_agent.core.prompt_templates import PromptTemplate, expand_prompt_template
from harn_coding_agent.core.resource_loader import ResourceLoaderLike
...
from harn_coding_agent.core.slash_commands import SlashCommandInfo, _make_slash_command_info
from harn_coding_agent.core.source_info import SourceInfo, create_synthetic_source_info
from harn_coding_agent.core.system_prompt import BuildSystemPromptOptions, build_system_prompt
from harn_coding_agent.core.tools import create_all_tool_definitions
from harn_coding_agent.core.tools.bash import create_local_bash_operations
from harn_coding_agent.core.tools.tool_definition_wrapper import (
    create_tool_definition_from_agent_tool,
    wrap_tool_definition,
)
from harn_coding_agent.modes.interactive.theme.theme import theme
from harn_coding_agent.utils.frontmatter import strip_frontmatter
from harn_coding_agent.utils.paths import resolve_path
