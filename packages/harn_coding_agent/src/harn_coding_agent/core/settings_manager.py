...
from harn_coding_agent.config import CONFIG_DIR_NAME, get_agent_dir
from harn_coding_agent.core.http_dispatcher import (
...
class SettingsManager:
    ...
    def getClearOnShrink(self) -> bool:
        ...
        return os.environ.get("HARN_CLEAR_ON_SHRINK") == "1"
    ...
    def getShowHardwareCursor(self) -> bool:
        ...
        return os.environ.get("HARN_HARDWARE_CURSOR") == "1"
