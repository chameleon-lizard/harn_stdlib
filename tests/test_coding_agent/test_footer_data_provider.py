...
import pytest
import harn_coding_agent.core.footer_data_provider as footer_data_provider_module
...
def test_footer_data_provider_uses_head_directly_in_regular_repo(
    ...
    calls: list[str] = []
    monkeypatch.setattr(
        "harn_coding_agent.core.footer_data_provider._resolve_branch_with_git_sync",
